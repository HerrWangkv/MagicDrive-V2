...
model = dict(
    ...
    # load pretrained
    from_pretrained="outputs/MagicDriveSTDiT3-XL-2-Pedestrian_pedestrian_20260112-0928/epoch0-global_step2000/ema.pt",
...
# Log settings
seed = 42
outputs = "outputs/test_pedestrian_65/CogVAE-848"
wandb = False
epochs = 150
log_every = 1
ckpt_every = 500 * 5
