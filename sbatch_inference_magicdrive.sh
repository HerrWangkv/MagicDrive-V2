#!/bin/bash
#SBATCH --job-name=inference_magicdrive
#SBATCH --nodes=1
...
#SBATCH --output=logs/inference_magicdrive_%j.out
#SBATCH --error=logs/inference_magicdrive_%j.err
...
apptainer exec --nv --writable-tmpfs \
    ...
    bash -c "
        ...
        torchrun --nproc-per-node=4 --nnodes=$SLURM_JOB_NUM_NODES --node_rank=$SLURM_NODEID \
            ...
            scripts/inference_magicdrive.py configs/magicdrive/inference/fullx848x1600_stdit3_CogVAE_boxTDS_wCT_xCE_wSST.py \
